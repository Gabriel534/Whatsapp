...
"                background: transparent;}")
        ...
        self.pushButtonConversas = QPushButton(self.widget)
        self.pushButtonConversas.setObjectName(u"pushButtonConversas")
        icon = QIcon()
        icon.addFile(u"data/conversas.png", QSize(), QIcon.Normal, QIcon.Off)
        self.pushButtonConversas.setIcon(icon)

        self.verticalLayout_2.addWidget(self.pushButtonConversas)

        self.pushButtonContatos = QPushButton(self.widget)
        self.pushButtonContatos.setObjectName(u"pushButtonContatos")
        sizePolicy1 = QSizePolicy(QSizePolicy.Preferred, QSizePolicy.Fixed)
        sizePolicy1.setHorizontalStretch(0)
        sizePolicy1.setVerticalStretch(0)
        sizePolicy1.setHeightForWidth(self.pushButtonContatos.sizePolicy().hasHeightForWidth())
        self.pushButtonContatos.setSizePolicy(sizePolicy1)
        icon1 = QIcon()
        icon1.addFile(u"data/contatos.png", QSize(), QIcon.Normal, QIcon.Off)
        self.pushButtonContatos.setIcon(icon1)

        self.verticalLayout_2.addWidget(self.pushButtonContatos)
        ...
        icon2 = QIcon()
        icon2.addFile(u"data/+.png", QSize(), QIcon.Normal, QIcon.Off)
        self.pushButtonAdicionarContato.setIcon(icon2)
        ...
        icon3 = QIcon()
        icon3.addFile(u"data/X.png", QSize(), QIcon.Normal, QIcon.Off)
        self.pushButtonRemoverContato.setIcon(icon3)
        ...
        icon4 = QIcon()
        icon4.addFile(u"data/bloquear.png", QSize(), QIcon.Normal, QIcon.Off)
        self.pushButtonBloquearContato.setIcon(icon4)
        ...
        sizePolicy2.setHeightForWidth(self.pushButtonConfiguracao.sizePolicy().hasHeightForWidth())
        self.pushButtonConfiguracao.setSizePolicy(sizePolicy2)
        icon5 = QIcon()
        icon5.addFile(u"data/configuracao.png", QSize(), QIcon.Normal, QIcon.Off)
        self.pushButtonConfiguracao.setIcon(icon5)
...
"            }")
        ...
        sizePolicy3.setHeightForWidth(self.Chats.sizePolicy().hasHeightForWidth())
        self.Chats.setSizePolicy(sizePolicy3)
        ...
        sizePolicy2.setHeightForWidth(self.QWidgetListaConversas.sizePolicy().hasHeightForWidth())
        self.QWidgetListaConversas.setSizePolicy(sizePolicy2)
        ...
        sizePolicy4.setHeightForWidth(self.Conversa.sizePolicy().hasHeightForWidth())
        self.Conversa.setSizePolicy(sizePolicy4)
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 498, 482))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButtonConversas.setText("")
